...
export default function Login() {
  ...
  return (
    <main className="login-shell relative min-h-screen overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(255,255,255,0.08)_42%,rgba(255,255,255,0.28)_100%)]" />

      <section className="relative z-10 grid min-h-screen place-items-center p-5 sm:p-8">
        <div className="grid w-full max-w-6xl overflow-hidden rounded-[2rem] border border-white/15 bg-white/10 shadow-2xl shadow-black/30 backdrop-blur-2xl lg:grid-cols-[0.9fr_1.1fr]">
          <aside className="relative hidden overflow-hidden bg-white/72 p-10 text-slate-900 lg:block xl:p-14">
            ...
            <div className="relative flex items-center gap-3">
              <AppIcon name="logo" className="brand-mark h-12 w-12" />
              <div>
                <p className="text-2xl font-black">TuitionTrack</p>
                <p className="text-sm text-teal-700/75">Teacher dashboard</p>
              </div>
            </div>

            <div className="relative mt-24">
              <p className="max-w-sm text-5xl font-black leading-[1.04] tracking-tight">Manage tuition with clarity.</p>
            ...
            <div className="relative mt-10 grid gap-3">
              {[
                ...
                <div key={item} className="flex items-center gap-3 rounded-2xl border border-white/70 bg-white/55 px-4 py-3 text-sm font-semibold shadow-sm backdrop-blur">
          ...
          <form onSubmit={submit} className="bg-white/95 p-7 sm:p-10 lg:px-20 lg:py-16">
            <div className="mx-auto max-w-md">
              <AppIcon name="logo" className="brand-mark mx-auto h-12 w-12" />
